...
<style>
body {
	font-family: "Times New Roman", Georgia, Serif;padding:1px;
}
...
<br><br>
<h3><u style="color:red;">${Message}</u></h3>
	</header>
	
	<h3><u style="color:red;">${enterValidEmail}</u></h3>
	</header>
...
<h3>Log In</h3>
		...
		<div class="container">
			<table>
				...
				<tr>
					<td>Password:</td>
					<td><input type="password" name="password" placeholder="Passwrod"></td>
				</tr>
		...
		<a href="/com.xworks.commonmodule/forgot"
					...
					<h3><u style="color:red;">${doestNotExist}</u></h3>
